...
shinyUI(pageWithSidebar(
  ...
  sidebarPanel(
    h3("Swiftkey Next Word Predictor"),
    p("Welcome to the web application for the Coursera's Data Science last part: 
      Capstone Project SwiftKey Word prediction aka Next Word Predictor."), br(),
    ...
    numericInput("nsug", "N degree of sugested words", 10, min=5, max=20),
    
    # Autor
    br(), br(), br(), br(), br(), br(), br(), br(), br(),
    p("Author: Bhargav Dalal - Dec, 2016"),
